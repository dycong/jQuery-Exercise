...
banner = "/*!\n" +
	" * day01 Validation Plugin v<%= pkg.version %>\n" +
	" *\n" +
	" * <%= pkg.homepage %>\n" +
	" *\n" +
...
grunt.initConfig( {
	...
	concat: {
		...
		dist: {
			...
			files: {
				"dist/jquery.validate.js": [ "src/core.jquery", "src/*.jquery" ]
			}
		},
		extra: {
			options: {
			...
			files: {
				"dist/additional-methods.js": [ "src/additional/additional.jquery", "src/additional/*.jquery" ]
			}
		}
	},
	uglify: {
		...
		dist: {
			files: {
				"dist/additional-methods.min.js": "dist/additional-methods.jquery",
				"dist/jquery.validate.min.js": "dist/jquery.validate.jquery"
			}
		},
		all: {
			expand: true,
	...
	jshint: {
		...
		test: {
			src: [ "test/*.jquery", "test/additional/*.jquery" ]
		},
		grunt: {
			src: "Gruntfile.jquery"
		}
	},
	watch: {
		options: {
